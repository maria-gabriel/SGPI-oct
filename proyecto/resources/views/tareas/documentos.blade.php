        ...
        <div class="card app-content-body">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <h6 class="font-size-11 text-uppercase mb-4 uppercase">{{$tarea->nombre}} documentos</h6>
                    <div>
                ...
                <div class="row formulario bg-ghost rounded mb-3" style="display: none;">
                    {!! Form::open(['route' => ['tareas.store', $tarea], 'method' => 'post', 'class' => 'container', 'enctype' => 'multipart/form-data']) !!}
                    <div class="container">
                ...
                @foreach($documentos as $key => $documento)
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="card app-file-list">
                            <a href="../../documents/tareas/{{$documento->nombre_doc}}" target="_blank">
