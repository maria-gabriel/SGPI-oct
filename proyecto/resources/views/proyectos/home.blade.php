        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title">Proyectos de todos los sectores</h4>
                    <div>
                ...
                <p class="mb-4">Presiona <span class="text-success text-bold">nuevo</span> para crear un proyecto. Para
                    ...
                    o <span class="text-secondary text-bold">finalizar</span>, seleccione la fila <span
                        class="text-md">☑</span> y presione el botón correspondiente. <br><span class="text-muted text-xs">Al eliminar o finalizar un proyecto, las tareas y subtareas subyacentes serán alteradas respectivamente.</span>
                </p>
...
$(document).ready(function() {
    ...
    function createChild(row) {
        ...
        var table = '<div class="card-body py-2">'+
                        ...
                        '<ul>'+
                            '<li>'+
                                ...
                                '<ul>'+
                                    ...
                                    dias + ' días <span class="'+ (dias3 == 0 ? 'text-warning' : dias3 > 0 ? 'text-info' : 'text-danger') +' text-xs">' + (dias2 > 0 ? "(" + dias2 + " días de atraso)" : "") + (dias3 == 0 ? "(Se entrega hoy)" : dias3 > 0 ? "(" + dias3 + " días restantes)" : "") +'</span></li>'+
                                '</ul>'+
                            '</li>'+
                            '<li>'+
                ...
                '</ul>'+
            '</div>'+
            '<div class="row mx-5 my-2"><button class="btn btn-secondary btn-sm mr-1" type="button" onclick="opengraphic('+rowData.id+');">Gráfica gantt</button><button class="btn btn-info btn-sm mr-1" type="button" onclick="opendocument('+rowData.id+');">Añadir documento</button></div>'
